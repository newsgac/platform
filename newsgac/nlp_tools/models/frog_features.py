feature_descriptions = {
    ...
    'direct_quotes_perc': 'The percentage of direct quotes with regards to the total number of tokens',
    ...
    'pronoun_1_perc_wdq': 'The percentage of the occurrence of first person pronouns with regards to the total number of tokens including the direct quotes',
    ...
    'pronoun_2_perc_wdq': 'The percentage of the occurrence of second person pronouns with regards to the total number of tokens including the direct quotes',
