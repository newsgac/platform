...
import newsgac.users.errors as UserErrors
import newsgac.models.users.constants as UserConstants
...
class User(object):
    ...
    def register_user(username, name, surname, email, password):
        ...
        User(username, name, surname, email, utils.hash_password(password)).save_to_db()
