...
from newsgac.data_engineering.preprocessing import Preprocessor, remove_stop_words, apply_lemmatization, get_clean_ocr
...
class DataSource(object):
    ...
    def get_user_friendly_created(self):
        return utils.get_local_display_time(self.created)

    def get_user_friendly_processing_started(self):
        return utils.get_local_display_time(self.processing_started)

    def get_user_friendly_processing_finished(self):
        return utils.get_local_display_time(self.processing_completed)
